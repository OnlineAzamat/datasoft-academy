  ...
  return (
    <section className={`${styles.paddings} relative z-10`}>
      <CCarousel className="px-[5%] h-max" interval={5000} controls>
        <CCarouselItem>
          <div className="flex lg:flex-row flex-col sm:gap-6 gap-1 2xl:max-w-[1280px] w-full">
            <div
            ...
            >
              ...
              <p className="mt-[0.5rem] font-normal text-[14px] leading-[29px] max-sm:leading-[1.5rem] text-white">🤝 <Trans i18nKey="feedback_1-text" values={{ feedback_1_2: "DataSoft Academy" }} components={{
